    ...
    <div>
      ...
      {posts.length === 0 ? (
        <div className="text-center py-12">
          <h2 className="text-2xl font-semibold mb-4">No posts found with this tag</h2>
              ...
              <div className="p-6 flex-grow">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {post.tags.map(t => (
                    <Link 
                      key={t} 
                      to={`/blog/tag/${t.toLowerCase()}`}
                      className={`text-xs px-2 py-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors ${
